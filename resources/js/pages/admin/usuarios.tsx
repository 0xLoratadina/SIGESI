...
import {
    ...
    update,
    destroy,
} from '@/actions/App/Http/Controllers/Admin/UsuarioController';
...
import type { BreadcrumbItem, Credenciales, SharedData } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Usuarios', href: usuarios().url },
];
...
export default function UsuariosAdmin({ usuarios }: Props) {
    ...
    const totalPaginas = Math.max(
        1,
        Math.ceil(usuariosFiltrados.length / elementosPorPagina),
    );
    ...
    function enviarEditar(e: FormEvent) {
        e.preventDefault();
        if (!editando) return;
        formEditar.put(update.url(editando.id), {
            preserveScroll: true,
            onSuccess: cerrar,
        });
    }
            ...
            <div className="flex min-w-0 flex-col gap-4 p-4 md:min-h-0 md:flex-1">
                <div className="flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-wrap gap-2">
                        <Button
                            variant={!filtroRol ? 'default' : 'outline'}
                            size="sm"
                            ...
                            <>
                                ...
                                >
                                    <Table className="min-w-[700px] table-fixed">
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead className="w-[18%] pl-[25px]">
                                                    Nombre
                                                </TableHead>
                                            ...
                                            {usuariosPaginados.map(
                                                (usuario) => (
                                                    <TableRow key={usuario.id}>
                                                        <TableCell className="truncate pl-[25px] font-medium">
                                                            {usuario.name}
                                                        </TableCell>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        >
                            ...
                            <div className="grid gap-2">
                                <Label>Rol *</Label>
                                <Select
                                    value={formCrear.data.rol}
                                    onValueChange={(v) =>
                                        formCrear.setData('rol', v as Rol)
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                            ...
                            <DialogFooter>
                                ...
                                <Button
                                    type="submit"
                                    disabled={formCrear.processing}
                                >
                                    {formCrear.processing
                                        ? 'Creando...'
                                        : 'Crear usuario'}
                                </Button>
                            </DialogFooter>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        >
                            ...
                            <div className="grid gap-2">
                                <Label>Rol *</Label>
                                <Select
                                    value={formEditar.data.rol}
                                    onValueChange={(v) =>
                                        formEditar.setData('rol', v as Rol)
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                            ...
                            <div className="grid gap-2">
                                ...
                                <InputError
                                    message={
                                        formEditar.errors.password_temporal
                                    }
                                />
                            </div>
                            <DialogFooter>
                ...
                >
                    <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Envia estas credenciales al usuario para que
