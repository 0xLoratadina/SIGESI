...
import {
    ...
    update,
    destroy,
} from '@/actions/App/Http/Controllers/Admin/PrioridadController';
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <p className="text-sm text-muted-foreground">
                    {prioridades.length} prioridad(es)
                </p>
                <Dialog
                    open={abierto}
                    onOpenChange={(v) => {
                                    ...
                                    <div className="grid gap-4 py-4">
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            <div className="grid gap-2">
                                                ...
                                                />
                                                <InputError
                                                    message={errors.nivel}
                                                />
                                            </div>
                                            <div className="grid gap-2">
                                                <Label htmlFor="horas_respuesta">
                                                    Hrs. Respuesta *
                                                </Label>
                                                <Input
                                                    id="horas_respuesta"
                                                ...
                                                <InputError
                                                    message={
                                                        errors.horas_respuesta
                                                    }
                                                />
                                            </div>
                                            <div className="grid gap-2">
                                                <Label htmlFor="horas_resolucion">
                                                    Hrs. Resolución *
                                                </Label>
                                                <Input
                                                    id="horas_resolucion"
                            ...
                            {prioridades.map((pri) => (
                                <TableRow key={pri.id}>
                                    ...
                                    <TableCell className="hidden sm:table-cell">
                                        {pri.horas_respuesta}h
                                    </TableCell>
                                    <TableCell className="hidden sm:table-cell">
                                        {pri.horas_resolucion}h
                                    </TableCell>
                                    <TableCell>
                                        <Badge
                                            variant={
